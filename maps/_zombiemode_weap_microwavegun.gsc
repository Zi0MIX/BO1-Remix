...
//	level._effect["microwavegun_smoke_cloud"]				= loadfx( "weapon/thunder_gun/fx_thundergun_smoke_cloud" );
	...
	level thread maps\_remix_zombiemode_weap_microwavegun::post_init();
}
...
wait_for_microwavegun_fired()
{
	...
	for( ;; )
	{
		...
		{
			self thread maps\_remix_zombiemode_weap_microwavegun::microwavegun_fired( currentweapon == "microwavegun_upgraded_zm" );
...
microwavegun_zombie_damage_response( mod, hit_location, hit_origin, player, amount )
{
	...
	{
		self thread maps\_remix_zombiemode_weap_microwavegun::microwavegun_dw_zombie_hit_response_internal( mod, self.damageweapon, player );
		return true;
	}
