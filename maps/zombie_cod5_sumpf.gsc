...
main()
{
	...
	level thread maps\_remix_sumpf::remix_main();
	...
	maps\_remix_sumpf::include_weapons();
	maps\_remix_sumpf::include_powerups();
	...
	level.zone_manager_init_func = maps\_remix_sumpf::sumpf_zone_init;
...
init_sounds()
{
	...
	level thread maps\_remix_sumpf::radio_eggs();
...
radio_two()
{
	...
	radio_two_trig waittill( "trigger" );
	level.radio_counter = level.radio_counter + 1;
...
radio_three()
{
	...
	radio_three_trig waittill( "trigger" );
	level.radio_counter = level.radio_counter + 1;
