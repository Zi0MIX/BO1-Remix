...
//	self thread do_player_playvox_egg( prefix, index, sound_to_play, waittime, category, type, override );
    ...
    // Originally used coast specific function do_player_playvox_egg, but they seem similar enough that this can be changed
	self maps\_remix_zombiemode_audio::do_player_playvox( prefix, index, sound_to_play, waittime, category, type, override );
}
